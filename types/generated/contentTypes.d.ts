...
export interface ApiSemiRawMaterialSemiRawMaterial
  extends Schema.CollectionType {
  collectionName: 'semi_raw_materials';
  info: {
    singularName: 'semi-raw-material';
    pluralName: 'semi-raw-materials';
    displayName: 'SemiRawMaterial';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::semi-raw-material.semi-raw-material',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::semi-raw-material.semi-raw-material': ApiSemiRawMaterialSemiRawMaterial;
